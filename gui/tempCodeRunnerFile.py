...
class MainApp:
    ...
    def setup_homescreen(self):
        ...
        self.processing_text = self.canvas.create_text(22.0, 165.0, anchor="nw", text="", fill="#D9D9D9", font=("Inter", 36))
    ...
    def start_clicked(self):
        ...
        if not self.laplacian_enabled and not self.star_enabled:
